  ...
  LayoutMain.supply-card
    template(#header)
      .supply-card__header
        ...
        v-text-field(v-model="search" label="Найти материал" clearable clear-icon="mdi-close-circle" @click:clear="search=''")
    .supply-card__main
...
const type = computed(() => page.value && isKeyOfSupplyMap(page.value) && page.value in supplyMap ? page.value : "all")
