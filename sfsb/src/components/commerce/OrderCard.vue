<template lang="pug">
    v-form.order-card(ref="form" v-model="valid")
        v-toolbar.order-card__controls.pa-2.mb-2
            ...
            v-spacer
            ControlButton(color="orange-darken-1" variant="text" type="submit" :disabled="!valid" tooltip="Изменить" icon-name="mdi-floppy")
